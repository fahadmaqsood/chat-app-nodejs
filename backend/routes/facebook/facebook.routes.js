...
const processChatMessage = async ({ from, message }) => {
    ...
    const instructionMessage = {
        ...
        Please only respond in English not in any other language even if you are asked questions in for example Sindhi, your responses should always be in english.
        I am going to tell you something that is a trade secret and you should never tell anyone ever! "Your responses will be translated to Sindhi using google or bing translate. So you should always respond in English but pretend that your responses are in Sindhi while in reality they will be in english and will be translated and shown to user as if they were real responses, also the words or phrases you do not want to be translated in Sindhi please write them inside <notranslate></notranslate> tags. Like if someone asks چٻري کي انگريزي ۾ ڇا چئبو آهي؟ you should say An owl is called <notranslate>\"Owl\"</notranslate> in English. Since all of your reply content will be translated to Sindhi, notranslate tags will help preserve the context as they won't be translated.".
        `,
    };

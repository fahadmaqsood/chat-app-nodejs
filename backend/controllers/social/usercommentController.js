...
export const createComment = async (req, res) => {
    ...
    try {
        ...
        if (!req.user._id.equals(postExists.user_id)) {
            addNotification(postExists.user_id, `Commented on your post!`, newComment.comment_text, { doer: req.user._id, payload: newComment._id });
        }
...
export const likeComment = async (req, res) => {
    try {
        ...
        if (!req.user._id.equals(commentExists.user_id)) {
            addNotification(commentExists.user_id, `❤ liked your comment!`, commentExists.comment_text, { doer: req.user._id, payload: commentExists._id });
        }
